...
DTSTAMP;VALUE=DATE-TIME:<?php print($current_date . "\n") ?>
DTSTART;<?php print $event['timezone'] ?>VALUE=DATE:<?php print(substr($event['start'],0,8) . "\n") ?>
<?php if (!empty($event['end'])): ?>
DTEND;<?php print $event['timezone'] ?>VALUE=DATE:<?php print(substr($event['end'],0,8) . "\n") ?>
<?php endif; ?>
